...
SOLUTION(2015, 20) {
    ...
    constexpr u32 Solve(const std::string& line, auto func, u32 hint) {
        u32 target;
    ...
    PART_ONE() {
        return Constexpr::ToString(Solve(lines[0], CountPresents, 700000));
    }

    PART_TWO() {
        return Constexpr::ToString(Solve(lines[0], CountLazyPresents, 800000));
    }
    TESTS() {
