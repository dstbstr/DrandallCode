...
#include "Common.h"
DECLARE_SOLUTION(2017, 7, R"RawInput_(mqdjo (83)
...
lezpa (84)
cfqdsb (556) -> feizivp, vjhsczt, gmxbjg)RawInput_" R"RawInput_(
oclbecq (78)
qqypffg (67)
lrdpo (91)
kvolhll (77)
...
pthrzgd (38)
ghicha (72)
vlrtfe (114) -> aosrim, pnlmj)RawInput_" R"RawInput_(
...
hjrhs (79))RawInput_" R"RawInput_(
zwxvo (58)
...
pbdww (79)
ewvfvx (55)
pxwsb (210) -> isozjve, vzubyy)RawInput_" R"RawInput_(
rscwd (81)
abghrf (56)
...
twxghfp (91)
tngvv (27)
koklf (61) -> jqtbsy, eetpan, vamssbi, rvwvokn, vpjsxth)RawInput_");