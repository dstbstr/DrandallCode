...
#include "Common.h"
DECLARE_SOLUTION(2017, 4, R"RawInput_(nyot babgr babgr kqtu kqtu kzshonp ylyk psqk
...
dhu zxdfiyv xuz xuz mgaty mgaty)RawInput_" R"RawInput_(
...
inc mpys mzqmcwx vryz ibqrzc pmsy fat rojpxwy rcbqzi gjef)RawInput_");