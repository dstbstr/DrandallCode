...
bool RunTests() {
    if (PartTwo("<>") != 0) return false;
    if (PartTwo("<random characters>") != 17) return false;
    if (PartTwo("<<<<>") != 3) return false;
    if (PartTwo("<{!>}>") != 2) return false;
    if (PartTwo("<!!>") != 0) return false;
    if (PartTwo("<!!!>>") != 0) return false;
    if (PartTwo("<{o\"i!a,<{i<a>") != 10) return false;
    /*
