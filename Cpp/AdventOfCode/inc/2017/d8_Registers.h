...
#include "Common.h"
DECLARE_SOLUTION(2017, 8, R"RawInput_(n dec 271 if az < 3
f inc -978 if nm <= 9
g inc -336 if ga < 2
egk dec 437 if y < 5
z dec -550 if g == -336
...
ga dec -482 if v <= 1026)RawInput_" R"RawInput_(
...
n inc 526 if mx >= -149
f inc -727 if egk != 2475)RawInput_" R"RawInput_(
ga inc 345 if g >= 622
...
mx dec -635 if av >= 3658)RawInput_" R"RawInput_(
...
vkg inc -257 if v >= -1921)RawInput_");