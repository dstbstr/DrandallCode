...
DECLARE_SOLUTION(2022, 16, R"RawInput_(Valve JC has flow rate=0; tunnels lead to valves XS, XK
...
Valve WC has flow rate=0; tunnels lead to valves OE, AA)RawInput_");