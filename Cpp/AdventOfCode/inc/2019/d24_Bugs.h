...
static_assert(CalcDiversity(ParseGrid({
    ".....",
    ".....",
    ".....",
    "#....",
...
auto PartTwo(const std::vector<std::string>& lines, size_t minutes) {
...
std::string Run(const std::vector<std::string>& lines) {
    ...
    return ToString(PartTwo(lines, 200));
}
...
bool RunTests() {
    ...
    if (PartTwo(lines, 10) != 99) return false;
