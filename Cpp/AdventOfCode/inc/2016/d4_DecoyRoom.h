...
#include "Common.h"
DECLARE_SOLUTION(2016, 4, R"RawInput_(fubrjhqlf-edvnhw-dftxlvlwlrq-803[wjvzd]
...
uiovmbqk-rmttgjmiv-bmkpvwtwog-850[lsyvi])RawInput_" R"RawInput_(
...
ujqgywfau-xdgowj-wfyafwwjafy-866[wfajy])RawInput_" R"RawInput_(
...
dsxxw-qaytclecp-fslr-nspafyqgle-990[swktj])RawInput_" R"RawInput_(
...
zsxyfgqj-hqfxxnknji-idj-xytwflj-359[jxfin])RawInput_");