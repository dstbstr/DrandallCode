...
DECLARE_SOLUTION(2020, 7, R"RawInput_(shiny aqua bags contain 1 dark white bag.
...
pale orange bags contain 2 posh fuchsia bags, 2 clear salmon bags, 2 bright green bags.)RawInput_" R"RawInput_(
...
posh aqua bags contain 4 drab lime bags, 4 dull tan bags, 5 vibrant tan bags.)RawInput_" R"RawInput_(
...
muted salmon bags contain 2 drab tan bags, 5 wavy tomato bags.)RawInput_" R"RawInput_(
...
pale blue bags contain 2 muted gold bags, 4 vibrant brown bags, 1 light lavender bag.)RawInput_" R"RawInput_(
...
muted green bags contain 2 dull magenta bags, 5 clear cyan bags.)RawInput_" R"RawInput_(
...
dotted gold bags contain 3 shiny red bags, 3 dull fuchsia bags.)RawInput_" R"RawInput_(
...
drab purple bags contain 1 shiny indigo bag, 4 striped yellow bags.)RawInput_");