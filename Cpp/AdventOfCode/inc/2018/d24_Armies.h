...
DECLARE_SOLUTION(2018, 24, R"RawInput_(Immune System:
...
8714 units each with 7890 hit points with an attack that does 1 cold damage at initiative 3)RawInput_");