...
DECLARE_SOLUTION(2018, 10, R"RawInput_(position=<-41150,  41504> velocity=< 4, -4>
...
position=< 51936,  41511> velocity=<-5, -4>)RawInput_" R"RawInput_(
...
position=< 41587,  41505> velocity=<-4, -4>)RawInput_");