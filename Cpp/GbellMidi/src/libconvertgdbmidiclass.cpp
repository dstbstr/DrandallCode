...
void trkfill(track*& tp, void* var1, int sz1, void* var2, int sz2, int type)
...
void parsekey(char* arg, keysig& keystr, track* tp)
...
void parsetim(char* arg, tsig& ts, track* tp)

{
    ...
    *cp = '\0';
    ...
    ts.dd = atoi(cp);
    switch(ts.dd) {
    case 2: ts.dd = 0x01; break;
    case 4: ts.dd = 0x02; break;
    case 8: ts.dd = 0x03; break;
    case 16: ts.dd = 0x04; break;
    case 32: ts.dd = 0x05; break;
    default: ts.dd = 0x02; break;
    }
...
void parsetmp(char* arg, tmpo& tmp, int skip, track* tp)
...

{
    ...
    case 'd': *note = 14; break;
    case 'e': *note = 16; break;
    case 'f': *note = 17; break;
    case 'g': *note = 19; break;
...
void parsechord(char* arg, track* tp, int notelen)
...
void parsenot(char* arg, track* tp, int notelen)
...
void parsestacnot(char* arg, track* tp, int notelen)
...
void parsetype(char* arg, track* tp, const char* ptype)
...
int parselen(char* arg, track* tp)

{
    ...
    for(cp = arg; cp != NULL;) {
        ...
        if(tp->nu)
            ...
            switch(len) {
            case 11: totlen += 8 * ppqn; break;
            case 1: totlen += 4 * ppqn; break;
            case 2: totlen += 2 * ppqn; break;
            case 4: totlen += ppqn; break;
            case 43: totlen += (2 * ppqn) / 3; break;
            case 83: totlen += ppqn / 3; break;
            case 8: totlen += ppqn / 2; break;
            case 16: totlen += ppqn / 4; break;
            case 163: totlen += ppqn / 6; break;
            case 32: totlen += ppqn / 8; break;
            case 323: totlen += ppqn / 12; break;
            case 64: totlen += ppqn / 16; break;
            case 643: totlen += ppqn / 24; break;
            default: break;
            }
        }
...
void parsestuff(char* arg, track* tp, void (*parse)(char*, track*, int)) // great descriptive name here. :)
...
void parseinst(char* arg, track* tp)
...
int parsevel(char* arg, track* tp)
